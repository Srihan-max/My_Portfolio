        ...
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <a href="#top" className="flex items-center">
                    <img src="/assets/logo.png" alt="Logo" className="w-28 cursor-pointer mr-2" />
                    <span className="text-3xl font-bold text-white">portfolio.</span>
                </a>

                <ul ref={navLinkRef} className="hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 bg-white/10 shadow-sm font-Ovo dark:bg-transparent">
                    <li><a className='hover:text-gray-400 transition' href="#top">Home</a></li>
                    <li><a className='hover:text-gray-400 transition' href="#about">About</a></li>
                    <li><a className='hover:text-gray-400 transition' href="#services">Services</a></li>
                    <li><a className='hover:text-gray-400 transition' href="#work">Work</a></li>
                    <li><a className='hover:text-gray-400 transition' href="#contact">Contact</a></li>
                </ul>
